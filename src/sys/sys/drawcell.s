/*
 * drawcell.asm, draw a 4x6 cell character
 * Copyright 2004, 2008 Christopher Williams
 * NOTE: I intend to eventually replace this routine with the newer drawglyph
 * routine.
 * 
...
| 6x4 (small) font
| drawcell(int row, int col, int c)
drawcell:
	movem.l	%d3/%d4,-(%sp)
	move	8+4(%a7),%d1	| row
	move	8+6(%a7),%d2	| col
...
0:
	...
	moveq	#LCD_INCY,%d0
	moveq	#6-1,%d2		| num rows in glyph - 1
0:
