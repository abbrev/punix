...
extern void		utmpname(char *__file);
extern struct utmp	*getutent(void);
extern struct utmp	*getutid(struct utmp *__ut);
extern struct utmp	*getutline(struct utmp *__ut);
extern struct utmp	*pututline(struct utmp *__ut);
